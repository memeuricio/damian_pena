    ...
    >
      <div className="space-y-8">
        ...
        <div className="text-center border-b border-surface-200 pb-6">
          <div className="w-20 h-20 bg-accent-100 rounded-2xl flex items-center justify-center mx-auto mb-4 text-accent-800">
            ...
            <ul className="space-y-3">
              {service.deliverables.map((deliverable) => (
                <li key={deliverable} className="flex items-start">
                  <svg className="w-5 h-5 text-primary-700 mr-3 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                  </svg>
                  <span className="text-primary-900">{deliverable}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {PROCESS_STEPS.map(({ step, title, description }) => (
              <div key={step} className="text-center">
                <div className="w-12 h-12 bg-accent-100 rounded-full flex items-center justify-center mx-auto mb-2 text-accent-800 font-bold">
                  {step}
                </div>
