  ...
  return (
    <Card className="h-full flex flex-col">
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="w-12 h-12 bg-accent-100 rounded-xl flex items-center justify-center text-accent-800 shrink-0">
      ...
      {/* Description */}
      <p className="text-primary-800 mb-6 grow">
        {service.description}
      </p>
      ...
      <div className="mb-6">
        ...
        <ul className="space-y-1">
          {service.deliverables.slice(0, 3).map((deliverable) => (
            <li key={deliverable} className="text-sm text-primary-800 flex items-center">
              <svg className="w-3 h-3 text-primary-700 mr-2" fill="currentColor" viewBox="0 0 20 20">
          ...
          {service.deliverables.length > 3 && (
            <li className="text-sm text-primary-700 italic">
      ...
      <div className="border-t border-surface-200 pt-4 mt-auto">
        <div className="flex items-center justify-between mb-4">
          <div>
            <div className="text-sm text-primary-800">Tiempo estimado:</div>
            <div className="font-semibold text-primary-900">{service.estimatedTimeframe}</div>
          </div>
          {service.priceRange && (
            <div className="text-right">
              <div className="text-sm text-primary-800">Desde:</div>
              <div className="font-semibold text-accent-800">{service.priceRange}</div>
            </div>
          )}
        </div>
