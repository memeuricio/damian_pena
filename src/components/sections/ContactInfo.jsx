...
export default function ContactInfo() {
  ...
  // WhatsApp se arma desde el teléfono; LinkedIn e Instagram solo aparecen si
  // tienen URL configurada en mockData (antes eran enlaces href="#" muertos).
  const socialLinks = [
    linkedin && {
      name: 'LinkedIn',
      url: linkedin,
