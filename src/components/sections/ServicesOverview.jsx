  ...
  return (
    <section className="py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Additional Info */}
        <div className="mt-16 bg-panel rounded-2xl p-8 shadow-lg border border-black/10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center p-4 bg-sky-50 rounded-lg">
                ...
                <div className="text-sm text-primary-700">Respuesta promedio</div>
              </div>
              <div className="text-center p-4 bg-emerald-50 rounded-lg">
                <div className="text-3xl font-bold text-emerald-600 mb-2">100%</div>
                <div className="text-sm text-primary-700">Proyectos entregados</div>
              </div>
              <div className="text-center p-4 bg-accent-50 rounded-lg">
                <div className="text-3xl font-bold text-accent-800 mb-2">3+</div>
                <div className="text-sm text-primary-700">Años experiencia</div>
              </div>
              <div className="text-center p-4 bg-surface-100 rounded-lg">
                <div className="text-3xl font-bold text-primary-700 mb-2">50+</div>
                <div className="text-sm text-primary-700">Clientes satisfechos</div>
              </div>
            </div>
          </div>
        </div>
