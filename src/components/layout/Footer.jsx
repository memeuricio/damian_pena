...
import { professionalProfile, mockServices } from '../../data/mockData';
...
export default function Footer() {
  ...
  const { fullName, email, phone, location, title } = professionalProfile.personalInfo;
  const { linkedin, instagram } = professionalProfile.social;

  // Solo se muestran las redes que tengan URL configurada en mockData.
  const socialLinks = [
    linkedin && { name: 'LinkedIn', url: linkedin, path: 'M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z' },
    instagram && { name: 'Instagram', url: instagram, path: 'M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.618 5.367 11.986 11.988 11.986s11.987-5.368 11.987-11.986C24.014 5.367 18.635.001 12.017.001zm4.624 7.512l-2.077 9.442c-.155.705-.568.874-.915.874-.297 0-.623-.155-.934-.463L9.537 13.5l-2.15 2.151c-.238.238-.438.438-.9.438-.297 0-.623-.155-.934-.463l-1.934-1.934c-.238-.238-.438-.438-.438-.9 0-.297.155-.623.463-.934l2.151-2.15-3.865-3.178c-.308-.311-.463-.637-.463-.934 0-.347.169-.76.874-.915l9.442-2.077c.347-.077.694-.077 1.041 0z' },
  ].filter(Boolean);
